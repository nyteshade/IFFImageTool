/* <script id="fragment_shader3" type="x-shader/x-fragment"> */
  ...
  // Emulated input resolution.
    ...
    vec2 res = vec2(320.0 / 1.0, 200.0 / 1.0);
  #else
    // Optimize for resize.
...
*/
    vec2 FlippedFragmentCoordinate = (vec2(0.0, iResolution.y) - fragCoord.xy) * vec2(-1.0, 1.0);
    vec2 pos = Warp(FlippedFragmentCoordinate / iResolution.xy);
